    ...
    public class ApiKeyDelegatingHandler : DelegatingHandler
    {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            if (request.Content != null)
            {
                ...
                // System.Console.WriteLine("Request content base 64 ======> {0}", requestContentBase64String);
            }

            // Creating the raw signature string
            var signatureRawData = $"{this.appId}{requestHttpMethod}{requestUri}{requestTimeStamp}{nonce}{requestContentBase64String}";
            // System.Console.WriteLine("Signature raw data =============> {0}", signatureRawData);
            ...
            using (var hmac = new HMACSHA256(apiKeyBytes))
            {
                ...
                // System.Console.WriteLine("Reuqest signature base 64 ========> {0}", requestSignatureBase64String);
